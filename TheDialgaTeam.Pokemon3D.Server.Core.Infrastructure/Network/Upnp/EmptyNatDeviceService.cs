...
internal class EmptyNatDeviceService : INatDeviceService
{
    ...
    public Task<int> CreatePortMappingAsync(int port, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(port);
    }

    public Task DestroyPortMappingAsync(int port, CancellationToken cancellationToken = default)
    {
